...
class Stocker():
    ...
    def __init__(self, stock_id, start_date):
        
        
        # Symbol is used for labeling plots
        self.symbol = "stock_id : {}".format(stock_id)
        
        # Produce dataframe for price info
        dataframe = wb.DataReader(stock_id, data_source= "yahoo", start= start_date).reset_index()
...
#==============================================================================#
        ...
        self.changepoint_prior_scale = 0.25 
